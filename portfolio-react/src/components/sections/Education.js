...
import { FaGraduationCap, FaBriefcase, FaMedal, FaCertificate } from 'react-icons/fa';
...
const BgBlur = styled.div`
  ...
  height: 500px;
  border-radius: 50%;
  background: linear-gradient(45deg, rgba(126, 87, 194, 0.1), rgba(0, 168, 255, 0.1));
  filter: blur(120px);
  bottom: -200px;
  right: -200px;
  z-index: 0;
...
const TimelineContainer = styled(motion.div)`
  ...
  &:before {
    ...
    width: 4px;
    height: 100%;
    background: linear-gradient(to bottom, var(--primary-color), rgba(0, 168, 255, 0.3));
    border-radius: 2px;
  ...
  const education = [
    {
      ...
      description: 'Bilgisayar Mühendisliği bölümünde lisans eğitimi almaktayım. Eğitimim süresince, algoritma tasarımı, veri yapıları, yazılım mühendisliği ve web geliştirme konularında derinlemesine bilgi edindim.',
      achievements: [
        'GPA: 2.5/4.00',
    ...
    },
    {
      ...
      description: 'Üyesi olarak başladığım kulüpte başkanlık görevini yürütüyorum.',
      achievements: [
    ...
    <EducationSection id="education">
      ...
      <Container>
        ...
        >
          ...
          <Subtitle>Akademik geçmişim, iş deneyimlerim, sertifikalarım ve ödüllerim</Subtitle>
        </SectionHeading>
    ...
    <TimelineContent className="timeline-content">
      ...
      <TimelineAchievements>
        {(item.achievements || []).map((achievement, i) => (
          <TimelineAchievement key={i}>{achievement}</TimelineAchievement>
        ))}
      </TimelineAchievements>
